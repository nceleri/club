...
$f_apto_s = isset($_POST["f_apto_s"]) ? limpiarCadena($_POST["f_apto_s"]) : "";
...
switch ($_GET["op"]) {
	case 'guardaryeditar':
		if (!empty($nro_s)) {
			...
			// TABLA INFO_SOCIO
			$socio->insertar_Info($nro_s, $obra_social_s, $actividad, $f_alta_s, $f_apto_s, $fichadoUAR_s, $carnet_s, $ficha_s, $becado, $medio_pago_s, $categoria_s);
