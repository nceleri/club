...
class Socio
{
	...
	{
		global $conexion;
		$sql = "INSERT INTO socio (id_socio,nombre,apellido,cuit,fecha_nac,sexo)values ('$nro_s', '$nombre_s', '$apellido_s', '$cuil_s', '$f_nac_s','$sexo_s');";
	...
	{
		global $conexion;
		$sql = "INSERT INTO contacto_socio (id_socio,domicilio,ciudad,codigo_postal,celular,telefono,email) values ('$nro_s','$domicilio_s', '$ciudad_s', '$cpostal_s', '$nro_celular_s','$nro_tel_fijo_s','$email_s')";
		$e = $conexion->query($sql);
		if ($e) {
	...
	public function insertar_Info($nro_s, $obra_social_s, $division_s, $f_alta_s, $fichadoUAR_s, $carnet_s, $ficha_s, $becado, $medio_pago_s, $categoria_s, $actividad, $f_apto_s)
	{
		global $conexion;
		$sql = "INSERT INTO info_socio (id_socio,obra_social,fecha_alta,fichado_uar,carnet,ficha,becado,forma_de_pago,estado,categoria,actividad,apto_medico) values ('$nro_s','$obra_social_s', '$f_alta_s', '$fichadoUAR_s','$carnet_s','$ficha_s','$becado','$medio_pago_s','Alta', '$categoria_s','$actividad', '$f_apto_s' )";
		$e = $conexion->query($sql);
		if ($e) {
		} else {
	...
	public function listaraño()
	{
		$sql = "select s.fecha_nac,s.id_socio,s.nombre,s.apellido,i.estado,c.celular, i.fichado_uar, i.apto_medico from socio s, info_socio i ,contacto_socio c where s.id_socio = i.id_socio and i.id_socio = c.id_socio;";
		return ejecutarConsulta($sql);
	}
