			...
			<div class="row">
				...
				<div class="col-md-6 col-12" id="debito">
					...
					<div class="form-group col-md-12 col-12">
						...
						<input class="form-control" type="TEXT" id="c_nombre" name="c_nombre">
					</div>
					<div class="form-group col-md-12 col-12 label-floating ">
						<label class="control-label">Apellido</label>
						<input class="form-control" type="text" id="c_apellido" name="c_apellido" maxlength="30">
					</div>
					<div class="form-group col-md-12 col-12">
					...
					<div class="form-group col-md-12 col-12 label-floating">
						...
						<input class="form-control" type="number" id="c_numerocuenta" name="c_numerocuenta" maxlength="10">
					</div>
					<div class="form-group col-md-12 col-12 label-floating">
					...
					<div class="form-group col-md-12 col-12 label-floating">
						...
						<input class="form-control" type="text" id="c_banco" name="c_banco" maxlength="10">
					</div>
					<div class="form-group col-md-12 col-12 label-floating">
						<label class="control-label">Sucursal</label>
						<input class="form-control" type="number" id="c_sucursal" name="c_sucursal" maxlength="10">
					</div>
				</div>
